...
本研究采用WRF气象模式提供精细化的EMEP模式气象驱动场。WRF模式由FNL全球在分析数据驱动，其网格设置如图\ref{wangge}所示。模拟采用四重Domain，中心点设置在珠三角(23.5°N，113.7°E)，采用LAMBERT投影方式。模拟试验采用的物理参数化方案如表\ref{WRF物理参数化方案}所示。
