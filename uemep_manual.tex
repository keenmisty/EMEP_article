...
\item 代码下载
	...
	uEMEP目前为开放获取的开源模型，因此其源代码存放在了GitHub上。注:使用者需要首先对git有一定的基础\footnote{\href{https://www.liaoxuefeng.com/wiki/896043488029600}{Git简明教程}}。
具体下载路径为：\url{https://github.com/metno/uEMEP}。
